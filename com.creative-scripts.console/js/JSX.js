/*
    ...
    \ \ / / _ \ '__/ __| |/ _ \| '_ \    __) | | |
     \ V /  __/ |  \__ \ | (_) | | | |  / __/ _| |
      \_/ \___|_|  |___/_|\___/|_| |_| |_____(_)_|
...
// is now independent of NodeJS and CSInterface.js :-)                                                   //
...
(function() {
    ...
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    // Test is we're in an Adobe CEP environment and if not for example we are viewing the index.html in Chrome sets up dummy functions //
    // This will help testing outside of the host environment.                                                                          //
    // Obviously the jsx won't do anything useful and the callback will not be called!                                                  //
    //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

    if (!window.__adobe_cep__) {
        jsx = function() {};
        jsx.evalscript = jsx.script = jsx.file = jsx.evalfile = jsx.evalFile = jsx.evalScript = jsx.eval = function(script) {
            var message = '';
            message = 'A jsx script was called outside of an Adobe host and was not executed';
        ...
        if (forceEval) {
            ...
            jsxScript = (
                ...
                [
                    ...
                    "} catch (e) {",
                    "    (function(e) {",
                    "        var line, sourceLine, name, description, ErrorMessage, fileName, start, end, bug, beforeBug;",
                    ...
                    "        }",
                    "        if (e.start) {",
                    "           beforeBug = e.source.substring(0,e.start - 1).split(/[\\n\\r]/);",
                    "           beforeBug = beforeBug[beforeBug.length -1];",
                    "           ErrorMessage += '\\nBug: ' + beforeBug + '\u2a0b\u2a0b' + e.source.substring(e.start - 1, e.end) + '\u2a0b\u2a0b' + e.source.substring(e.end, 300);",
                    "        }",
